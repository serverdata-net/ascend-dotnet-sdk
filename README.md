# Ascend SDK for .NET
​
You can use this C# client library to integrate Ascend APIs into your application. To do this, you will need an Ascend account.
Before you start, we recommend that you visit our [Developer Portal](https://developer.ascendcloud.com/).
​
## Table of Contents
...
​
* AscendUC.SDK.Voice provides the client for [Voice API](https://developer.ascendcloud.com/api/spec/calling/index.html).
* AscendUC.SDK.Meetings provides the client for [Meetings API](https://developer.ascendcloud.com/api/spec/meeting/index.html).
* AscendUC.SDK.Analytics provides the client for [Analytics API](https://developer.ascendcloud.com/api/spec/analytics/index.html).
* AscendUC.SDK.Address Book provides the client for [Address Book API](https://developer.ascendcloud.com/api/spec/address_book/index.html).
* AscendUC.SDK provides all functionality.
​
...
​
``` cmd
dotnet add package AscendUC.SDK
```
​
Or run the following command in the Package Manager Console:
​
``` cmd
Install-Package AscendUC.SDK
```
​
If you prefer to run commands directly from source:
​
* clone this repository `git clone https://github.com/serverdata-net/ascend-dotnet-sdk`;
* add the Ascend-dotnet-sdk/AscendUC.SDK.csproj file to your .sln file;
* add the Ascend-dotnet-sdk/AscendUC.SDK.csproj file as a project dependency.
​
```xml
<ItemGroup>
    <ProjectReference Include="../ascend-dotnet-sdk/AscendUC.SDK.csproj" />
</ItemGroup>
```
​
Our experienced clients are recommended to install only the required libraries to decrease the size of an application result bundle. For example, if you are going to use the Analytics API, install Ascend.SDK.Analytics only.
​
## Supported APIs
​
Below is the list of Ascend APIs and the information on their support by Ascend .NET SDK.
​
...
Ascend uses JWT tokens to get access to the Ascend API. If you're going to use full SDK package we provide a generic `IAuthorizationTokenProvider` interface and `SimpleAuthorizationTokenProvider` class as default implementation. Our implementation is used for prototyping and examples. We strongly recommend to create own implementation of the interface.
...
```
​
Please visit our [Developer Portal](https://developer.ascendcloud.com/api/spec/meeting/index.html) for more information.
​
### Address Book API
​
#### Get User Details
...
```
​
Please visit our [Developer Portal](https://developer.ascendcloud.com/api/spec/address_book/index.html) for more information.
​
### Analytics API
​
#### Get Detailed Calls
...
```
​
Please visit our [Developer Portal](https://developer.ascendcloud.com/api/spec/analytics/index.html) for more information.
​
### Voice API
​
#### Make Call
...
```
​
Please visit our [Developer Portal](https://developer.ascendcloud.com/api/spec/calling/index.html) for more information about Voice API.
​
## License
​
